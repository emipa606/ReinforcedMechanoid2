...
namespace ReinforcedMechanoids
{
    public class SymbolResolverShips : SymbolResolver
    {
        public override void Resolve(ResolveParams rp)
        {
            ...
            Lord singlePawnLord = rp.singlePawnLord ?? LordMaker.MakeNewLord(faction, 
                new LordJob_DefendShip(faction, rp.rect.CenterCell), map, null);
            ...
            if (resolveParams.pawnGroupMakerParams == null && faction.def.pawnGroupMakers.Any(pgm => pgm.kindDef == PawnGroupKindDefOf.Settlement))
            {
                ...
                resolveParams.pawnGroupMakerParams.points = (map.Parent as Site).parts.MaxBy(x => x.parms.threatPoints).parms.threatPoints;
