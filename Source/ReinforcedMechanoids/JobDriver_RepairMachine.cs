...
internal class JobDriver_RepairMachine : JobDriver
{
        ...
        bool storageMode, bool tryStoreInSameStorageIfSpotCantHoldWholeStack = false)
    {
        ...
        toil.initAction = delegate
        {
            ...
            else
            {
                ...
                if (actor.carryTracker.TryDropCarriedThing(cell, ThingPlaceMode.Direct, out _, placedAction))
                {
                    return;
                }
                ...
                if (storageMode)
                {
                    ...
                    else
                    {
                        ...
                        {
                            Log.Error(
                                $"Incomplete haul for {actor}: Could not find anywhere to put {actor.carryTracker.CarriedThing} near {actor.Position}. Destroying. This should never happen!");
