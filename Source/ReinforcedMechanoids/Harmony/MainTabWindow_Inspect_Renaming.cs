...
public static class MainTabWindow_Inspect_Renaming
{
    ...
    public static void Postfix(Rect rect, ref float lineEndWidth)
    {
        ...
        if (Find.Selector.NumSelected != 1 || Find.Selector.SingleSelectedThing is not Machine drone ||
        ...
        var x = rect.width - 48f - renameSize;

        var renameArea = new Rect(x, 0.0f, renameSize, renameSize);
